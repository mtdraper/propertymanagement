...
class RepairRequestsControllerTest < ActionController::TestCase
  ...
  test "should update repair_request" do
    patch :update, id: @repair_request, repair_request: { close_date: @repair_request.close_date, open_date: @repair_request.open_date, request_details: @repair_request.request_details, request_response: @repair_request.request_response, responder_id: @repair_request.responder_id, submitter_id: @repair_request.submitter_id }
    assert_redirected_to repair_request_path(assigns(:repair_request))
  end
